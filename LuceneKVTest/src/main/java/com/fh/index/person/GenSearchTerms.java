    ...
    public static void genSearchTerms() throws Exception{
        ...
        try {
            ...
            while ((line = bcpReader.readLine()) != null) {
                ...
                String term = null;
                int type = rand.nextInt(5); // idno, mobile, vid
                if (type == 0){
                    term = "idno:" + person.idno;
                }else if (type == 1){
                    term = "mobile:" + person.mobile;
                } else {
                    int idx = rand.nextInt(person.vids.size());
                    term = "vids:" + person.vids.get(idx);
                }
